...
// i decided to add a mute button, it seemed like an easy idea and im still very new to javascript
// i experimented for awhile using if and else statements but i found this to be the simpliest way
