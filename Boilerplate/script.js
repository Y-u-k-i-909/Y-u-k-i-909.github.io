...
window.addEventListener("DOMContentLoaded", () => {
    ...
    let playlist = [
      {name: "half slept - relax", src: "sound/relax_master.wav"},
      {name: "half slept - call me", src: "sound/call me.1.wav"},
      {name: "half sle[pt - cash fx", src: "sound/cash fx.2.wav"}
    ];
